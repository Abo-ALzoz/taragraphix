...
class Page(HTMLParser):
    ...
    def handle_starttag(self, tag, attributes):
        ...
        if tag in ('img', 'video', 'source', 'script'):
            for name in ('src', 'data-src', 'poster', 'data-poster'):
                if attrs.get(name):
...
def build():
    ...
    # Artwork/video filenames are mutable, so do not mark them immutable.
    for route in ('/', '/index.html', '/images/*', '/images2/*', '/media/*'):
